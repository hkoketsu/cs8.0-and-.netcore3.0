...
namespace NorthwindMvc.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            if (!price.HasValue) return NotFound(
                "You must pass a product price in the query strin, for example," +
            ...
            if (model.Count() == 0) return NotFound($"No products cost more than {price:C}");
        ...
        {
            return View(); // the page with aform to submit
        }
        [HttpPost]
